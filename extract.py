...
from database_classes import insert_entity, PqlEntity, update_end_of_entity_with_id, \
    update_end_of_entity_and_in_json_with_id, delete_all_rows, migrate


#TODO This is only for Testing if we go on prod comment it out
def get_faker():
    faker1 = Faker()
    Faker.seed(4711)
    return faker1

faker1: Faker = get_faker()
