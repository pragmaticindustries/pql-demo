...
with open(os.path.join(here, "LICENSE"), encoding="utf-8") as fh:
    LICENSE = fh.read()
with open(os.path.join(src, "pql_demo", "__init__.py"), encoding="utf-8") as fh:
...
setuptools.setup(
    ...
    keywords="",
    project_urls={
        "Homepage": "https://pragmaticindustries.com/",
    },
    ...
    entry_points={"console_scripts": ["something =pql_demo.__main__:main"]},
    options={},
    platforms="",
    zip_safe=False,
)
