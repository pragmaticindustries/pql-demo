import extract
from database_classes import delete_all_rows, migrate, PqlEntity, get_all_entitys
    ...
    return {
        "Cycle": {
            "fields": {
                ...
                "uuid": extract.AutoGeneratedUUID(),
...
def test_one():
    ...
    list_entitys:[PqlEntity] = get_all_entitys()
...
def test_tool_and_others_not():
    ...
    assert results == {'ToolEquipped': [{'id': 1, 'uuid': 'b1cb1816-7d85-457c-9f32-2a1422d00e17','tool_name': 'Tool1', 'start': 1, 'end': 4}]}
    list_entitys:[PqlEntity] = get_all_entitys()
...
def test_tool_change_and_relation_with_cycle():
    ...
    assert results == {'ToolEquipped': [{'id': 1, 'tool_name': 'Tool1', 'uuid': 'b1cb1816-7d85-457c-9f32-2a1422d00e17', 'start': 1, 'end': 3},
                                        {'id': 2, 'tool_name': 'Tool2', 'uuid': '5bb7fb0f-d8d9-415b-8725-460b8ce504db', 'start': 4, 'end': 4},
                                        {'id': 3, 'tool_name': 'Tool3', 'uuid': 'ce9c02e4-aafb-4062-97ff-bbaaeca05990', 'start': 5, 'end': 5}]}
    list_entitys:[PqlEntity] = get_all_entitys()
...
def get_config6() -> dict:
    return {
        "Cycle": {
            "fields": {
                "id": Parameter("cycle_id"),                    "uuid": AutoGeneratedUUID(),
            },
            "primary_key": "id",
        },
        "ToolEquipped": {
