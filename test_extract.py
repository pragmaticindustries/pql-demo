from extract import Parameter, AutoGeneratedManyToOne, AutoGeneratedField, StateProcessor, AutoGeneratedOneToMany
...
def test_cycle_material_switch():
    ...
    assert results.get("MaterialEquipped")[0] == {'id': 1, 'material_name': 'Material 1', 'start': 1, 'end': 2}
    assert results.get("MaterialEquipped")[1] == {'id': 2, 'material_name': 'Material 2', 'start': 3, 'end': 4}
...
def test_tool_and_others_not():
    ...
    states = [
        {"timestamp": 1, "cycle_id": 21, "material_name": "Material 1", "tool_name": "Tool1"},
        {"timestamp": 2, "cycle_id": 21, "material_name": "Material 1","tool_name": "Tool1"},
        {"timestamp": 3, "cycle_id": 22, "material_name": "Material 2","tool_name": "Tool1"},
        {"timestamp": 4, "cycle_id": 22, "material_name": "Material 2","tool_name": "Tool1"}
    ]

    results = run_processor(states,config2,True)


    assert results == {'ToolEquipped':[{'id': 1, 'tool_name': 'Tool1', 'start': 1, 'end': 4}]}
...
def test_tool_change_and_old_config():
    ...
    states = [
        ...
        {"timestamp": 2, "cycle_id": 21, "material_name": "Material 1","tool_name": "Tool1"},
        {"timestamp": 3, "cycle_id": 22, "material_name": "Material 2","tool_name": "Tool1"},
        {"timestamp": 4, "cycle_id": 22, "material_name": "Material 2","tool_name": "Tool2"},
        {"timestamp": 5, "cycle_id": 22, "material_name": "Material 2","tool_name": "Tool3"}
    ]

    results = run_processor(states,config2,True)


    assert results == {'ToolEquipped':[{'id': 2, 'tool_name': 'Tool1', 'start': 1, 'end': 3},
...
def test_tool_change_and_relation_with_cycle():
    ...
    states = [
        {"timestamp": 1, "cycle_id": 21, "material_name": "Material 1", "tool_name": "Tool1"},
        {"timestamp": 2, "cycle_id": 21, "material_name": "Material 1","tool_name": "Tool1"},
        {"timestamp": 3, "cycle_id": 22, "material_name": "Material 2","tool_name": "Tool2"},
        {"timestamp": 4, "cycle_id": 22, "material_name": "Material 2","tool_name": "Tool2"},
        {"timestamp": 5, "cycle_id": 22, "material_name": "Material 2","tool_name": "Tool2"}
    ]

    results = run_processor(states,config3,True)

    assert results == {'ToolEquipped': [{'id': 1, 'tool_name': 'Tool1', 'start': 1, 'end': 2, 'cycle': 21},
...
def test_tool_change_and_relation_befor_entity():
    ...
    states = [
        {"timestamp": 1, "tool_name": "Tool1","cycle_id": 21, "material_name": "Material 1"},
        {"timestamp": 2, "tool_name": "Tool1","cycle_id": 21, "material_name": "Material 1"},
        {"timestamp": 3, "tool_name": "Tool2","cycle_id": 22, "material_name": "Material 2"},
        {"timestamp": 4, "tool_name": "Tool2","cycle_id": 22, "material_name": "Material 2"},
        {"timestamp": 5, "tool_name": "Tool2","cycle_id": 22, "material_name": "Material 2"}
    ]

    results = run_processor(states,config4,True)

    assert results == {'Cycle': [{'id': 21, 'start': 1, 'end': 2}, {'id': 22, 'start': 3, 'end': 5}],
                       'ToolEquipped': [{'id': 1, 'tool_name': 'Tool1', 'start': 1, 'end': 2, 'cycle': 21},
                                        {'id': 2, 'tool_name': 'Tool2', 'start': 3, 'end': 5, 'cycle': 22}]}